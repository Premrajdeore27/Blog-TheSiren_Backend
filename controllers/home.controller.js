...
var DataBase = [...Bollywood , ...Technology , ...Fitness , ...Hollywood , ...Food]
var Category=[
    Bollywood,
    Hollywood,
    Technology,
...
let article = DataBase.filter((item) => item.Category === param)
res.send(article)
console.log(article)
console.log(param)
}
...
let article = DataBase.filter((item) => item.id === +param)
res.send(article)
console.log(article)
console.log(param)
}
